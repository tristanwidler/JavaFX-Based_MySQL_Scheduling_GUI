...
/**This class is the controller of AddAppointmentMenu.fxml.
 * The class displays two TableViews and various buttons to create a new Appointment.
...
public class AddAppointmentController implements Initializable {
     ...
     * The method is used to populate the start year combination box, and the tableviews with information from the Repository.*/
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        //Populates the start and end year combo box
        for (int i=0; i<=100 ; i++) {
     ...
     * This method sends the user to SchedulingMenu.fxml without adding the Appointment.
    ...
    /** This method is called when the "Save Appointment" button is clicked.
    ...
    public void onActionSaveButton(ActionEvent event) throws IOException {
        ...
        if (isValidInput())
        {
            ...
            if (userChoice == 0) {
                if (Repository.apptIsAvailable(utcStartDT, utcEndDT, apptDate, startTimeUTC, endTimeUTC, custID, contID)) {
                    try {
                        // Example insert statement:
                        //"INSERT INTO appointments VALUES(null,'Checkup', 'description', 'location', 'Planning Session', '2020-05-28 12:00:00', '2020-05-28 13:00:00', NOW(), 'script', NOW(), 'script', 1, 1, 3)";
                        DBQuery.setPreparedStatement(JDBC.connection, "INSERT INTO appointments VALUES(null,?, ?, ?, ?, ?, ?, NOW(), ?, NOW(), ?, ?, ?, ?)");
                        ...
                        ps.setString(7, Repository.getCurrentUsername());
                        ps.setString(8, Repository.getCurrentUsername());
                        ps.setString(9, custID);
                        ps.setString(10, String.valueOf(Repository.getCurrentUserID())); //Not sure of this one...
                        ps.setString(11, contID);
    ...
    //Start and end date/time Combination Box methods:
